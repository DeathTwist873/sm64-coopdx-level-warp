...
🛠️ Technical QA Notes (For Reviewers)
Velocity Reset: The script hooks into HOOK_ON_LEVEL_INIT to automatically reset the player's velocity vectors (me.vel.x, me.vel.y, me.vel.z = 0,0,0) immediately after a warp completes. This prevents "momentum carry-over" bugs that cause players to instantly fall or fly to their death upon spawning into a new map level.
